...
function createClick() {
  ...
  t71 =
    "\n71- Why Are You A Criminal?: The nemesis has a potent and extremely profitable healing ability. They can heal themselves, or any one they are within physical contact with, 2d[2xStarRating] HP or target a number of people within 10 units equal to their Star Rating for half the healing dice.\n";
  t72 =
  ...
  t73 =
    "\n73- Neurotoxin: The nemesis has their melee weapons and ammo coated in a potent toxin. Upon dealing HP damage to a target, a Endurance or Medicine check must be made with a DC equal to x2 their Star Rating that stacks with each hit up to 4 times. This toxin causes 2dStarRating damage per round until the target hits -Max HP or they pass the DC. The DC goes down by 1 every time a target meets the resist DC.  (Trickster Specialty)\n";
  t74 =
    "\n74- Feint: The Nemesis gains Sleight of Hand as a secondary skill and, upon a successful bluff against the target's Insight, reduces the target's AD by an amount equal to their ranks in the skill. (Trickster Specialty)\n";
...
function createClick2() {
  ...
  t12 =
    "\n\n12. Elastic Man: The nemesis' body is rubbery in nature, giving them equalized PD across their body and Reach to all melee attacks equal to their Dexterity. They are immune to physical damage but being hit by ice attacks removes all the benefits of this trait and halves their PD.\n\n";
...
function createClickPH() {
  ...
  t22 =
    "\n22- Neurotoxin: The nemesis has their melee weapons and ammo coated in a potent toxin. Upon dealing HP damage to a target, a Endurance or Medicine check must be made with a DC equal to x2 their Star Rating that stacks with each hit up to 4 times. This toxin causes 2dStarRating damage per round until the target hits -Max HP or they pass the DC. The DC goes down by 1 every time a target meets the resist DC.\n";
