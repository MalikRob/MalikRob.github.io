$(document).ready(function () {
  ...
  $("#stars-creature").on("change", function () {
    ...
    switch (a) {
      ...
      default:
        alert("Bug Encountered; Ping Blonk");
    }
...
function crmiscConditions() {
  ...
  switch (document.querySelector("#stars-creature").value) {
    case "1":
      document.querySelector("#cnumt").innerText = "1";
      document.querySelector("#clv").innerText = "Street(ie12)";
      break;

    case "2":
      document.querySelector("#cnumt").innerText = "2";
      document.querySelector("#clv").innerText = "Street(ie12)";
      break;

    case "3":
      document.querySelector("#cnumt").innerText = "4";
      document.querySelector("#clv").innerText = "Street(ie12)";
      break;

    case "4":
      document.querySelector("#cnumt").innerText = "6";
      document.querySelector("#clv").innerText = "Adventurer(ie10)";
      break;

    case "5":
      document.querySelector("#cnumt").innerText = "8";
      document.querySelector("#clv").innerText = "Spandex(ie8)";
      break;

    case "6":
      document.querySelector("#cnumt").innerText = "14";
      document.querySelector("#clv").innerText = "Cosmic(ie6)";
      break;
...
function copycrPage() {
  ...
  msg += `Speed: ${document.getElementById("cspd").innerText}\n`;
  msg += `Dexterity: ${document.getElementById("cdex").innerText}\n`;
  msg += `Durability: ${document.getElementById("cdur").innerText}\n`;
  msg += `Endurance: ${document.getElementById("cend").innerText}\n`;
  msg += `Senses: ${document.getElementById("csen").innerText}\n`;
  ...
  msg += `\nSkills:\n`;
  msg += `Ranks Per Star Rating - ${document.getElementById("cskillra-num").innerText}\n`;
  msg += `Rank Cap - ${document.getElementById("cskillca-num").innerText}\n`;
